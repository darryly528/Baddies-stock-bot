...
type SiteTheme = { bgUrl: string | null };
type UserTheme = { bgUrl: string | null };
...
export default function Home() {
  ...
  const { data: siteTheme } = useQuery<SiteTheme>({
    queryKey: ["site-theme"],
  ...
  const hasBackground = !!(userTheme?.bgUrl ?? siteTheme?.bgUrl);
